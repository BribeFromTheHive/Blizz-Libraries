...
--===================================================
          ...
          RACE_PREF_USER_SELECTABLE           = ConvertRacePref(64)
              ...
              MAP_CONTROL_NONE                    = ConvertMapControl(5)
               ...
               MAP_PLACEMENT_FIXED                 = ConvertPlacement(1)   --  0 in start loc 0...
...
--===================================================
    ...
    -- cumulative resources collected by the  during the mission
    --
...
--
--  When an  causes a  to fire these
--  values allow the action  to determine which
--   was dispatched and therefore which set of
--  function functions should be used to get information
--  about the .
--
...
--===================================================
    ...
    -- Events which may have a filter for the "other "              
    --                                                                  
    ...
    -- Events which involve the specified  performing               
    ...
    -- variable,  state, game state, and  state events
...
--===================================================
                   ...
                   OSKEY_BACKSPACE                      = ConvertOsKeyType(string.format("%x", "08"))
                   OSKEY_TAB                            = ConvertOsKeyType(string.format("%x", "09"))
                   OSKEY_CLEAR                          = ConvertOsKeyType(string.format("%x", "0C"))
                   OSKEY_RETURN                         = ConvertOsKeyType(string.format("%x", "0D"))
                   OSKEY_SHIFT                          = ConvertOsKeyType(string.format("%x", "10"))
                   OSKEY_CONTROL                        = ConvertOsKeyType(string.format("%x", "11"))
                   OSKEY_ALT                            = ConvertOsKeyType(string.format("%x", "12"))
                   OSKEY_PAUSE                          = ConvertOsKeyType(string.format("%x", "13"))
                   OSKEY_CAPSLOCK                       = ConvertOsKeyType(string.format("%x", "14"))
                   OSKEY_KANA                           = ConvertOsKeyType(string.format("%x", "15"))
                   OSKEY_HANGUL                         = ConvertOsKeyType(string.format("%x", "15"))
                   OSKEY_JUNJA                          = ConvertOsKeyType(string.format("%x", "17"))
                   OSKEY_FINAL                          = ConvertOsKeyType(string.format("%x", "18"))
                   OSKEY_HANJA                          = ConvertOsKeyType(string.format("%x", "19"))
                   OSKEY_KANJI                          = ConvertOsKeyType(string.format("%x", "19"))
                   OSKEY_ESCAPE                         = ConvertOsKeyType(string.format("%x", "1B"))
                   OSKEY_CONVERT                        = ConvertOsKeyType(string.format("%x", "1C"))
                   OSKEY_NONCONVERT                     = ConvertOsKeyType(string.format("%x", "1D"))
                   OSKEY_ACCEPT                         = ConvertOsKeyType(string.format("%x", "1E"))
                   OSKEY_MODECHANGE                     = ConvertOsKeyType(string.format("%x", "1F"))
                   OSKEY_SPACE                          = ConvertOsKeyType(string.format("%x", "20"))
                   OSKEY_PAGEUP                         = ConvertOsKeyType(string.format("%x", "21"))
                   OSKEY_PAGEDOWN                       = ConvertOsKeyType(string.format("%x", "22"))
                   OSKEY_END                            = ConvertOsKeyType(string.format("%x", "23"))
                   OSKEY_HOME                           = ConvertOsKeyType(string.format("%x", "24"))
                   OSKEY_LEFT                           = ConvertOsKeyType(string.format("%x", "25"))
                   OSKEY_UP                             = ConvertOsKeyType(string.format("%x", "26"))
                   OSKEY_RIGHT                          = ConvertOsKeyType(string.format("%x", "27"))
                   OSKEY_DOWN                           = ConvertOsKeyType(string.format("%x", "28"))
                   OSKEY_SELECT                         = ConvertOsKeyType(string.format("%x", "29"))
                   OSKEY_PRINT                          = ConvertOsKeyType(string.format("%x", "2A"))
                   OSKEY_EXECUTE                        = ConvertOsKeyType(string.format("%x", "2B"))
                   OSKEY_PRINTSCREEN                    = ConvertOsKeyType(string.format("%x", "2C"))
                   OSKEY_INSERT                         = ConvertOsKeyType(string.format("%x", "2D"))
                   OSKEY_DELETE                         = ConvertOsKeyType(string.format("%x", "2E"))
                   OSKEY_HELP                           = ConvertOsKeyType(string.format("%x", "2F"))
                   OSKEY_0                              = ConvertOsKeyType(string.format("%x", "30"))
                   OSKEY_1                              = ConvertOsKeyType(string.format("%x", "31"))
                   OSKEY_2                              = ConvertOsKeyType(string.format("%x", "32"))
                   OSKEY_3                              = ConvertOsKeyType(string.format("%x", "33"))
                   OSKEY_4                              = ConvertOsKeyType(string.format("%x", "34"))
                   OSKEY_5                              = ConvertOsKeyType(string.format("%x", "35"))
                   OSKEY_6                              = ConvertOsKeyType(string.format("%x", "36"))
                   OSKEY_7                              = ConvertOsKeyType(string.format("%x", "37"))
                   OSKEY_8                              = ConvertOsKeyType(string.format("%x", "38"))
                   OSKEY_9                              = ConvertOsKeyType(string.format("%x", "39"))
                   OSKEY_A                              = ConvertOsKeyType(string.format("%x", "41"))
                   OSKEY_B                              = ConvertOsKeyType(string.format("%x", "42"))
                   OSKEY_C                              = ConvertOsKeyType(string.format("%x", "43"))
                   OSKEY_D                              = ConvertOsKeyType(string.format("%x", "44"))
                   OSKEY_E                              = ConvertOsKeyType(string.format("%x", "45"))
                   OSKEY_F                              = ConvertOsKeyType(string.format("%x", "46"))
                   OSKEY_G                              = ConvertOsKeyType(string.format("%x", "47"))
                   OSKEY_H                              = ConvertOsKeyType(string.format("%x", "48"))
                   OSKEY_I                              = ConvertOsKeyType(string.format("%x", "49"))
                   OSKEY_J                              = ConvertOsKeyType(string.format("%x", "4A"))
                   OSKEY_K                              = ConvertOsKeyType(string.format("%x", "4B"))
                   OSKEY_L                              = ConvertOsKeyType(string.format("%x", "4C"))
                   OSKEY_M                              = ConvertOsKeyType(string.format("%x", "4D"))
                   OSKEY_N                              = ConvertOsKeyType(string.format("%x", "4E"))
                   OSKEY_O                              = ConvertOsKeyType(string.format("%x", "4F"))
                   OSKEY_P                              = ConvertOsKeyType(string.format("%x", "50"))
                   OSKEY_Q                              = ConvertOsKeyType(string.format("%x", "51"))
                   OSKEY_R                              = ConvertOsKeyType(string.format("%x", "52"))
                   OSKEY_S                              = ConvertOsKeyType(string.format("%x", "53"))
                   OSKEY_T                              = ConvertOsKeyType(string.format("%x", "54"))
                   OSKEY_U                              = ConvertOsKeyType(string.format("%x", "55"))
                   OSKEY_V                              = ConvertOsKeyType(string.format("%x", "56"))
                   OSKEY_W                              = ConvertOsKeyType(string.format("%x", "57"))
                   OSKEY_X                              = ConvertOsKeyType(string.format("%x", "58"))
                   OSKEY_Y                              = ConvertOsKeyType(string.format("%x", "59"))
                   OSKEY_Z                              = ConvertOsKeyType(string.format("%x", "5A"))
                   OSKEY_LMETA                          = ConvertOsKeyType(string.format("%x", "5B"))
                   OSKEY_RMETA                          = ConvertOsKeyType(string.format("%x", "5C"))
                   OSKEY_APPS                           = ConvertOsKeyType(string.format("%x", "5D"))
                   OSKEY_SLEEP                          = ConvertOsKeyType(string.format("%x", "5F"))
                   OSKEY_NUMPAD0                        = ConvertOsKeyType(string.format("%x", "60"))
                   OSKEY_NUMPAD1                        = ConvertOsKeyType(string.format("%x", "61"))
                   OSKEY_NUMPAD2                        = ConvertOsKeyType(string.format("%x", "62"))
                   OSKEY_NUMPAD3                        = ConvertOsKeyType(string.format("%x", "63"))
                   OSKEY_NUMPAD4                        = ConvertOsKeyType(string.format("%x", "64"))
                   OSKEY_NUMPAD5                        = ConvertOsKeyType(string.format("%x", "65"))
                   OSKEY_NUMPAD6                        = ConvertOsKeyType(string.format("%x", "66"))
                   OSKEY_NUMPAD7                        = ConvertOsKeyType(string.format("%x", "67"))
                   OSKEY_NUMPAD8                        = ConvertOsKeyType(string.format("%x", "68"))
                   OSKEY_NUMPAD9                        = ConvertOsKeyType(string.format("%x", "69"))
                   OSKEY_MULTIPLY                       = ConvertOsKeyType(string.format("%x", "6A"))
                   OSKEY_ADD                            = ConvertOsKeyType(string.format("%x", "6B"))
                   OSKEY_SEPARATOR                      = ConvertOsKeyType(string.format("%x", "6C"))
                   OSKEY_SUBTRACT                       = ConvertOsKeyType(string.format("%x", "6D"))
                   OSKEY_DECIMAL                        = ConvertOsKeyType(string.format("%x", "6E"))
                   OSKEY_DIVIDE                         = ConvertOsKeyType(string.format("%x", "6F"))
                   OSKEY_F1                             = ConvertOsKeyType(string.format("%x", "70"))
                   OSKEY_F2                             = ConvertOsKeyType(string.format("%x", "71"))
                   OSKEY_F3                             = ConvertOsKeyType(string.format("%x", "72"))
                   OSKEY_F4                             = ConvertOsKeyType(string.format("%x", "73"))
                   OSKEY_F5                             = ConvertOsKeyType(string.format("%x", "74"))
                   OSKEY_F6                             = ConvertOsKeyType(string.format("%x", "75"))
                   OSKEY_F7                             = ConvertOsKeyType(string.format("%x", "76"))
                   OSKEY_F8                             = ConvertOsKeyType(string.format("%x", "77"))
                   OSKEY_F9                             = ConvertOsKeyType(string.format("%x", "78"))
                   OSKEY_F10                            = ConvertOsKeyType(string.format("%x", "79"))
                   OSKEY_F11                            = ConvertOsKeyType(string.format("%x", "7A"))
                   OSKEY_F12                            = ConvertOsKeyType(string.format("%x", "7B"))
                   OSKEY_F13                            = ConvertOsKeyType(string.format("%x", "7C"))
                   OSKEY_F14                            = ConvertOsKeyType(string.format("%x", "7D"))
                   OSKEY_F15                            = ConvertOsKeyType(string.format("%x", "7E"))
                   OSKEY_F16                            = ConvertOsKeyType(string.format("%x", "7F"))
                   OSKEY_F17                            = ConvertOsKeyType(string.format("%x", "80"))
                   OSKEY_F18                            = ConvertOsKeyType(string.format("%x", "81"))
                   OSKEY_F19                            = ConvertOsKeyType(string.format("%x", "82"))
                   OSKEY_F20                            = ConvertOsKeyType(string.format("%x", "83"))
                   OSKEY_F21                            = ConvertOsKeyType(string.format("%x", "84"))
                   OSKEY_F22                            = ConvertOsKeyType(string.format("%x", "85"))
                   OSKEY_F23                            = ConvertOsKeyType(string.format("%x", "86"))
                   OSKEY_F24                            = ConvertOsKeyType(string.format("%x", "87"))
                   OSKEY_NUMLOCK                        = ConvertOsKeyType(string.format("%x", "90"))
                   OSKEY_SCROLLLOCK                     = ConvertOsKeyType(string.format("%x", "91"))
                   OSKEY_OEM_NEC_EQUAL                  = ConvertOsKeyType(string.format("%x", "92"))
                   OSKEY_OEM_FJ_JISHO                   = ConvertOsKeyType(string.format("%x", "92"))
                   OSKEY_OEM_FJ_MASSHOU                 = ConvertOsKeyType(string.format("%x", "93"))
                   OSKEY_OEM_FJ_TOUROKU                 = ConvertOsKeyType(string.format("%x", "94"))
                   OSKEY_OEM_FJ_LOYA                    = ConvertOsKeyType(string.format("%x", "95"))
                   OSKEY_OEM_FJ_ROYA                    = ConvertOsKeyType(string.format("%x", "96"))
                   OSKEY_LSHIFT                         = ConvertOsKeyType(string.format("%x", "A0"))
                   OSKEY_RSHIFT                         = ConvertOsKeyType(string.format("%x", "A1"))
                   OSKEY_LCONTROL                       = ConvertOsKeyType(string.format("%x", "A2"))
                   OSKEY_RCONTROL                       = ConvertOsKeyType(string.format("%x", "A3"))
                   OSKEY_LALT                           = ConvertOsKeyType(string.format("%x", "A4"))
                   OSKEY_RALT                           = ConvertOsKeyType(string.format("%x", "A5"))
                   OSKEY_BROWSER_BACK                   = ConvertOsKeyType(string.format("%x", "A6"))
                   OSKEY_BROWSER_FORWARD                = ConvertOsKeyType(string.format("%x", "A7"))
                   OSKEY_BROWSER_REFRESH                = ConvertOsKeyType(string.format("%x", "A8"))
                   OSKEY_BROWSER_STOP                   = ConvertOsKeyType(string.format("%x", "A9"))
                   OSKEY_BROWSER_SEARCH                 = ConvertOsKeyType(string.format("%x", "AA"))
                   OSKEY_BROWSER_FAVORITES              = ConvertOsKeyType(string.format("%x", "AB"))
                   OSKEY_BROWSER_HOME                   = ConvertOsKeyType(string.format("%x", "AC"))
                   OSKEY_VOLUME_MUTE                    = ConvertOsKeyType(string.format("%x", "AD"))
                   OSKEY_VOLUME_DOWN                    = ConvertOsKeyType(string.format("%x", "AE"))
                   OSKEY_VOLUME_UP                      = ConvertOsKeyType(string.format("%x", "AF"))
                   OSKEY_MEDIA_NEXT_TRACK               = ConvertOsKeyType(string.format("%x", "B0"))
                   OSKEY_MEDIA_PREV_TRACK               = ConvertOsKeyType(string.format("%x", "B1"))
                   OSKEY_MEDIA_STOP                     = ConvertOsKeyType(string.format("%x", "B2"))
                   OSKEY_MEDIA_PLAY_PAUSE               = ConvertOsKeyType(string.format("%x", "B3"))
                   OSKEY_LAUNCH_MAIL                    = ConvertOsKeyType(string.format("%x", "B4"))
                   OSKEY_LAUNCH_MEDIA_SELECT            = ConvertOsKeyType(string.format("%x", "B5"))
                   OSKEY_LAUNCH_APP1                    = ConvertOsKeyType(string.format("%x", "B6"))
                   OSKEY_LAUNCH_APP2                    = ConvertOsKeyType(string.format("%x", "B7"))
                   OSKEY_OEM_1                          = ConvertOsKeyType(string.format("%x", "BA"))
                   OSKEY_OEM_PLUS                       = ConvertOsKeyType(string.format("%x", "BB"))
                   OSKEY_OEM_COMMA                      = ConvertOsKeyType(string.format("%x", "BC"))
                   OSKEY_OEM_MINUS                      = ConvertOsKeyType(string.format("%x", "BD"))
                   OSKEY_OEM_PERIOD                     = ConvertOsKeyType(string.format("%x", "BE"))
                   OSKEY_OEM_2                          = ConvertOsKeyType(string.format("%x", "BF"))
                   OSKEY_OEM_3                          = ConvertOsKeyType(string.format("%x", "C0"))
                   OSKEY_OEM_4                          = ConvertOsKeyType(string.format("%x", "DB"))
                   OSKEY_OEM_5                          = ConvertOsKeyType(string.format("%x", "DC"))
                   OSKEY_OEM_6                          = ConvertOsKeyType(string.format("%x", "DD"))
                   OSKEY_OEM_7                          = ConvertOsKeyType(string.format("%x", "DE"))
                   OSKEY_OEM_8                          = ConvertOsKeyType(string.format("%x", "DF"))
                   OSKEY_OEM_AX                         = ConvertOsKeyType(string.format("%x", "E1"))
                   OSKEY_OEM_102                        = ConvertOsKeyType(string.format("%x", "E2"))
                   OSKEY_ICO_HELP                       = ConvertOsKeyType(string.format("%x", "E3"))
                   OSKEY_ICO_00                         = ConvertOsKeyType(string.format("%x", "E4"))
                   OSKEY_PROCESSKEY                     = ConvertOsKeyType(string.format("%x", "E5"))
                   OSKEY_ICO_CLEAR                      = ConvertOsKeyType(string.format("%x", "E6"))
                   OSKEY_PACKET                         = ConvertOsKeyType(string.format("%x", "E7"))
                   OSKEY_OEM_RESET                      = ConvertOsKeyType(string.format("%x", "E9"))
                   OSKEY_OEM_JUMP                       = ConvertOsKeyType(string.format("%x", "EA"))
                   OSKEY_OEM_PA1                        = ConvertOsKeyType(string.format("%x", "EB"))
                   OSKEY_OEM_PA2                        = ConvertOsKeyType(string.format("%x", "EC"))
                   OSKEY_OEM_PA3                        = ConvertOsKeyType(string.format("%x", "ED"))
                   OSKEY_OEM_WSCTRL                     = ConvertOsKeyType(string.format("%x", "EE"))
                   OSKEY_OEM_CUSEL                      = ConvertOsKeyType(string.format("%x", "EF"))
                   OSKEY_OEM_ATTN                       = ConvertOsKeyType(string.format("%x", "F0"))
                   OSKEY_OEM_FINISH                     = ConvertOsKeyType(string.format("%x", "F1"))
                   OSKEY_OEM_COPY                       = ConvertOsKeyType(string.format("%x", "F2"))
                   OSKEY_OEM_AUTO                       = ConvertOsKeyType(string.format("%x", "F3"))
                   OSKEY_OEM_ENLW                       = ConvertOsKeyType(string.format("%x", "F4"))
                   OSKEY_OEM_BACKTAB                    = ConvertOsKeyType(string.format("%x", "F5"))
                   OSKEY_ATTN                           = ConvertOsKeyType(string.format("%x", "F6"))
                   OSKEY_CRSEL                          = ConvertOsKeyType(string.format("%x", "F7"))
                   OSKEY_EXSEL                          = ConvertOsKeyType(string.format("%x", "F8"))
                   OSKEY_EREOF                          = ConvertOsKeyType(string.format("%x", "F9"))
                   OSKEY_PLAY                           = ConvertOsKeyType(string.format("%x", "FA"))
                   OSKEY_ZOOM                           = ConvertOsKeyType(string.format("%x", "FB"))
                   OSKEY_NONAME                         = ConvertOsKeyType(string.format("%x", "FC"))
                   OSKEY_PA1                            = ConvertOsKeyType(string.format("%x", "FD"))
                   OSKEY_OEM_CLEAR                      = ConvertOsKeyType(string.format("%x", "FE"))
...
-- Expect values between -1 and 1...) end0 for invalid input
function Asin     (  y ) end
function Acos     (  x ) end
...
-- forces  to have the specified start loc and marks the start loc as occupied
-- which removes it from consideration for subsequently placed players
-- ( i.e. you can use this to put people in a fixed loc and then
--   use random  for any unplaced players etc )
...
-- a better implementation would be a  that adds relevant units as they enter
...
-- This function is asynchronous. The values it ) endare not guaranteed synchronous between each .
...
--============================================================================
-- Boolean Expr API ( for compositing  conditions and  filter funcs...)
--============================================================================
...
function TriggerRegisterVariableEvent (  whichTrigger,  varName,  opcode,  limitval ) end
    ...
    -- function  GetTriggeringVariableName (  ) end

-- Creates it's own  and triggers when it expires
function TriggerRegisterTimerEvent (  whichTrigger,  timeout,  periodic ) end

-- Triggers when the  you tell it about expires
...
-- ) endthe actual  they typed in ( same as what you registered for
-- if you required exact match )
 function GetEventPlayerChatString (  ) end

-- ) endthe  that you registered for
...
-- ) end to  which triggered the most recent  when called from
-- within a  action function...) endnull  when used incorrectly
...
-- See the Player Unit Construction Event API above for  info funcs

-- EVENT_UNIT_TRAIN_START
-- EVENT_UNIT_TRAIN_CANCELLED
-- EVENT_UNIT_TRAIN_FINISH

-- See the Player Unit Training Event API above for  info funcs

-- EVENT_UNIT_SELL

-- See the Player Unit Sell Event API above for  info funcs

-- EVENT_UNIT_DROP_ITEM
-- EVENT_UNIT_PICKUP_ITEM
-- EVENT_UNIT_USE_ITEM
-- See the Player Unit/Item manipulation Event API above for  info funcs

-- EVENT_UNIT_ISSUED_ORDER
-- EVENT_UNIT_ISSUED_POINT_ORDER
-- EVENT_UNIT_ISSUED_TARGET_ORDER

-- See the Player Unit Order Event API above for  info funcs
...
function  SaveInteger						(  hashT,  parentKey,  childKey,  value ) end
function  SaveReal						(  hashT,  parentKey,  childKey,  value ) end
function  SaveBoolean						(  hashT,  parentKey,  childKey,  value ) end
function  SaveStr							(  hashT,  parentKey,  childKey,  value ) end
function  SavePlayerHandle				(  hashT,  parentKey,  childKey,  whichPlayer ) end
function  SaveWidgetHandle				(  hashT,  parentKey,  childKey,  whichWidget ) end
function  SaveDestructableHandle			(  hashT,  parentKey,  childKey,  whichDestructable ) end
function  SaveItemHandle					(  hashT,  parentKey,  childKey,  whichItem ) end
function  SaveUnitHandle					(  hashT,  parentKey,  childKey,  whichUnit ) end
function  SaveAbilityHandle				(  hashT,  parentKey,  childKey,  whichAbility ) end
function  SaveTimerHandle					(  hashT,  parentKey,  childKey,  whichTimer ) end
function  SaveTriggerHandle				(  hashT,  parentKey,  childKey,  whichTrigger ) end
function  SaveTriggerConditionHandle		(  hashT,  parentKey,  childKey,  whichTriggercondition ) end
function  SaveTriggerActionHandle			(  hashT,  parentKey,  childKey,  whichTriggeraction ) end
function  SaveTriggerEventHandle			(  hashT,  parentKey,  childKey,  whichEvent ) end
function  SaveForceHandle					(  hashT,  parentKey,  childKey,  whichForce ) end
function  SaveGroupHandle					(  hashT,  parentKey,  childKey,  whichGroup ) end
function  SaveLocationHandle				(  hashT,  parentKey,  childKey,  whichLocation ) end
function  SaveRectHandle					(  hashT,  parentKey,  childKey,  whichRect ) end
function  SaveBooleanExprHandle			(  hashT,  parentKey,  childKey,  whichBoolexpr ) end
function  SaveSoundHandle					(  hashT,  parentKey,  childKey,  whichSound ) end
function  SaveEffectHandle				(  hashT,  parentKey,  childKey, whichEffect ) end
function  SaveUnitPoolHandle				(  hashT,  parentKey,  childKey, whichUnitpool ) end
function  SaveItemPoolHandle				(  hashT,  parentKey,  childKey,  whichItempool ) end
function  SaveQuestHandle					(  hashT,  parentKey,  childKey,  whichQuest ) end
function  SaveQuestItemHandle				(  hashT,  parentKey,  childKey,  whichQuestitem ) end
function  SaveDefeatConditionHandle		(  hashT,  parentKey,  childKey,  whichDefeatcondition ) end
function  SaveTimerDialogHandle			(  hashT,  parentKey,  childKey,  whichTimerdialog ) end
function  SaveLeaderboardHandle			(  hashT,  parentKey,  childKey,  whichLeaderboard ) end
function  SaveMultiboardHandle			(  hashT,  parentKey,  childKey,  whichMultiboard ) end
function  SaveMultiboardItemHandle		(  hashT,  parentKey,  childKey,  whichMultiboarditem ) end
function  SaveTrackableHandle				(  hashT,  parentKey,  childKey,  whichTrackable ) end
function  SaveDialogHandle				(  hashT,  parentKey,  childKey,  whichDialog ) end
function  SaveButtonHandle				(  hashT,  parentKey,  childKey,  whichButton ) end
function  SaveTextTagHandle				(  hashT,  parentKey,  childKey,  whichTexttag ) end
function  SaveLightningHandle				(  hashT,  parentKey,  childKey,  whichLightning ) end
function  SaveImageHandle					(  hashT,  parentKey,  childKey,  whichImage ) end
function  SaveUbersplatHandle				(  hashT,  parentKey,  childKey,  whichUbersplat ) end
function  SaveRegionHandle				(  hashT,  parentKey,  childKey,  whichRegion ) end
function  SaveFogStateHandle				(  hashT,  parentKey,  childKey,  whichFogState ) end
function  SaveFogModifierHandle			(  hashT,  parentKey,  childKey,  whichFogModifier ) end
function  SaveAgentHandle					(  hashT,  parentKey,  childKey,  whichAgent ) end
function  SaveHashtableHandle				(  hashT,  parentKey,  childKey,  whichHashtable ) end
function  SaveFrameHandle					(  hashT,  parentKey,  childKey,  whichFrameHandle ) end


function  LoadInteger					(  hashT,  parentKey,  childKey ) end
function  LoadReal					(  hashT,  parentKey,  childKey ) end
function  LoadBoolean				    (  hashT,  parentKey,  childKey ) end
function  LoadStr 					(  hashT,  parentKey,  childKey ) end
function  LoadPlayerHandle			(  hashT,  parentKey,  childKey ) end
function  LoadWidgetHandle			(  hashT,  parentKey,  childKey ) end
function  LoadDestructableHandle		(  hashT,  parentKey,  childKey ) end
function  LoadItemHandle				(  hashT,  parentKey,  childKey ) end
function  LoadUnitHandle				(  hashT,  parentKey,  childKey ) end
function  LoadAbilityHandle			(  hashT,  parentKey,  childKey ) end
function  LoadTimerHandle				(  hashT,  parentKey,  childKey ) end
function  LoadTriggerHandle			(  hashT,  parentKey,  childKey ) end
function  LoadTriggerConditionHandle	(  hashT,  parentKey,  childKey ) end
function  LoadTriggerActionHandle		(  hashT,  parentKey,  childKey ) end
function  LoadTriggerEventHandle		(  hashT,  parentKey,  childKey ) end
function  LoadForceHandle				(  hashT,  parentKey,  childKey ) end
function  LoadGroupHandle				(  hashT,  parentKey,  childKey ) end
function  LoadLocationHandle			(  hashT,  parentKey,  childKey ) end
function  LoadRectHandle				(  hashT,  parentKey,  childKey ) end
function  LoadBooleanExprHandle		(  hashT,  parentKey,  childKey ) end
function  LoadSoundHandle				(  hashT,  parentKey,  childKey ) end
function  LoadEffectHandle			(  hashT,  parentKey,  childKey ) end
function  LoadUnitPoolHandle			(  hashT,  parentKey,  childKey ) end
function  LoadItemPoolHandle			(  hashT,  parentKey,  childKey ) end
function  LoadQuestHandle				(  hashT,  parentKey,  childKey ) end
function  LoadQuestItemHandle			(  hashT,  parentKey,  childKey ) end
function  LoadDefeatConditionHandle	(  hashT,  parentKey,  childKey ) end
function  LoadTimerDialogHandle		(  hashT,  parentKey,  childKey ) end
function  LoadLeaderboardHandle		(  hashT,  parentKey,  childKey ) end
function  LoadMultiboardHandle		(  hashT,  parentKey,  childKey ) end
function  LoadMultiboardItemHandle	(  hashT,  parentKey,  childKey ) end
function  LoadTrackableHandle			(  hashT,  parentKey,  childKey ) end
function  LoadDialogHandle			(  hashT,  parentKey,  childKey ) end
function  LoadButtonHandle			(  hashT,  parentKey,  childKey ) end
function  LoadTextTagHandle			(  hashT,  parentKey,  childKey ) end
function  LoadLightningHandle			(  hashT,  parentKey,  childKey ) end
function  LoadImageHandle				(  hashT,  parentKey,  childKey ) end
function  LoadUbersplatHandle			(  hashT,  parentKey,  childKey ) end
function  LoadRegionHandle			(  hashT,  parentKey,  childKey ) end
function  LoadFogStateHandle			(  hashT,  parentKey,  childKey ) end
function  LoadFogModifierHandle		(  hashT,  parentKey,  childKey ) end
function  LoadHashtableHandle			(  hashT,  parentKey,  childKey ) end
function  LoadFrameHandle				(  hashT,  parentKey,  childKey ) end

function  HaveSavedInteger					(  hashT,  parentKey,  childKey ) end
function  HaveSavedReal						(  hashT,  parentKey,  childKey ) end
function  HaveSavedBoolean					(  hashT,  parentKey,  childKey ) end
function  HaveSavedString					    (  hashT,  parentKey,  childKey ) end
function  HaveSavedHandle     				(  hashT,  parentKey,  childKey ) end

function  RemoveSavedInteger					(  hashT,  parentKey,  childKey ) end
function  RemoveSavedReal						(  hashT,  parentKey,  childKey ) end
function  RemoveSavedBoolean					(  hashT,  parentKey,  childKey ) end
function  RemoveSavedString					(  hashT,  parentKey,  childKey ) end
function  RemoveSavedHandle					(  hashT,  parentKey,  childKey ) end

function  FlushParentHashtable						(  hashT ) end
function  FlushChildHashtable					(  hashT,  parentKey ) end
...
-- Choose any random /. (NP means Neutral Passive)
...
-- these calls are only valid if the  was created with 3d enabled
